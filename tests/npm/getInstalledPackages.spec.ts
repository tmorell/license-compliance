...
test.serial("Get all packages, full installation", async (t) => {
    ...
    t.truthy(packages.find(p => p.name === "prod-01" && p.version === "1.0.0" && p.repository === "https://github.com/user/project"));
    t.truthy(packages.find(p => p.name === "prod-03" && p.version === "3.0.0"));
    t.truthy(packages.find(p => p.name === "prod-02" && p.version === "2.0.0" && p.repository === Literals.UNKNOWN));
    t.truthy(packages.find(p => p.name === "@comp-01/core" && p.version === "0.5.6"));
    t.truthy(packages.find(p => p.name === "prod-02-02" && p.version === "0.0.2"));
    t.truthy(packages.find(p => p.name === "prod-02-02" && p.version === "2.0.0"));
    t.truthy(packages.find(p => p.name === "prod-05-05" && p.version === "6.7.8"));
    t.truthy(packages.find(p => p.name === "prod-04-04" && p.version === "0.3.2"));
    t.truthy(packages.find(p => p.name === "prod-04" && p.version === "1.2.3"));
    t.truthy(packages.find(p => p.name === "dev-01" && p.version === "0.5.0"));
    t.truthy(packages.find(p => p.name === "dev-02" && p.version === "0.6.0"));
});
...
test.serial("Only production, full installation", async (t) => {
    ...
    t.truthy(packages.find(p => p.name === "prod-01" && p.version === "1.0.0"));
    t.truthy(packages.find(p => p.name === "prod-02" && p.version === "2.0.0"));
    t.truthy(packages.find(p => p.name === "prod-02-02" && p.version === "2.0.0"));
    t.truthy(packages.find(p => p.name === "prod-03" && p.version === "3.0.0"));
    t.truthy(packages.find(p => p.name === "@comp-01/core" && p.version === "0.5.6"));
    t.truthy(packages.find(p => p.name === "prod-05-05" && p.version === "6.7.8"));
